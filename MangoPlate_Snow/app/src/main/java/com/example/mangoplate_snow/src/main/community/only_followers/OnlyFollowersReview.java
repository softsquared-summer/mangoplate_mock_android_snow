...
public class OnlyFollowersReview {
    ...
    public OnlyFollowersReview(String userNickname, String reviewCount, String followerCount, String restaurantNameAndLocation, String userReview, String likeCount, String commentCount, String timeAgo, boolean isWannagoChecked, boolean isLikeChecked, int overallAssess) {
