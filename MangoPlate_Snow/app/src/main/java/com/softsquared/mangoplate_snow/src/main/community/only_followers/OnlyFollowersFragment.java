...
import com.softsquared.mangoplate_snow.src.main.community.only_followers.interfaces.OnlyFollowersFragmentView;
...
public class OnlyFollowersFragment extends BaseFragment implements OnlyFollowersFragmentView {
    ...
    public OnlyFollowersFragment() {
    }

    public OnlyFollowersFragment(Context mContext) {
